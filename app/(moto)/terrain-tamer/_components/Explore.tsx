          ...
          <div className="order-1 xl:order-2 flex flex-col justify-center overflow-x-hidden overflow-y-hidden">
            ...
            <div className="flex flex-col gap-5 mt-5 overflow-x-hidden overflow-y-hidden">
              <p
                ...
                parts—it is the confidence and peace of mind that comes with
                knowing you have the right support when the journey gets tough.
                From demanding off-road conditions to remote locations, our
                products are built to handle the toughest challenges and keep
                your vehicle performing when you need it most.
              </p>
              ...
              <p
                ...
                data-aos-delay="600"
                data-aos-easing="ease-out-cubic">
                With expert advice, a massive range of quality 4WD parts, and a
                strong network of trusted repairers across Australia, Terrain
                Tamer provides dependable support wherever your journey takes
                you. Our experience, product availability, and industry
                connections help you find the right solution when you need it
                most, giving you the confidence to keep moving through demanding
                conditions and get back on the road safely.
              </p>
            </div>
