  ...
  return (
    ...
    >
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 2xl:gap-20 4xl:gap-32 items-center">
          ...
          {/* Right Column: Text */}
          <div data-aos="fade-left" className="lg:col-span-6 flex flex-col">

            <h2 className="section-title font-oswald font-semibold mb-6 2xl:mb-10 4xl:mb-16 text-[#272727] font-semibold">
            ...
            <p className="section-text font-rubik font-normal text-[#666666] mb-4 2xl:mb-8 4xl:mb-12 leading-relaxed">
            ...
            <p className="section-text font-rubik font-normal text-[#666666] mb-6 2xl:mb-12 4xl:mb-16 leading-relaxed">
