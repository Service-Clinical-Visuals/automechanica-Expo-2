              ...
              <nav className="hidden lg:flex items-center gap-12 inter-font">
                {navLinks.map((link) => (
                  <Link
                    key={link.name}
                    href={link.href}
                    className={`header-link transition-colors py-2 whitespace-nowrap flex items-center ${link.active
                      ? "text-[#000000] font-bold"
                      : "text-[#000000] hover:text-[#000000] font-regular hover:font-bold"
                      }`}
                  >
                    {link.name}
                  </Link>
