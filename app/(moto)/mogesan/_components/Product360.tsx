  ...
  return (
    <section className="w-full py-16 md:py-20 xl:py-[100px] bg-[#262626]">
      <div className="custom-container flex flex-col items-center text-center">
        <h2
          className="section-title text-white whitespace-nowrap mb-6"
          data-aos="fade-up">
          360° Product View
        </h2>
        ...
        <p
          ...
          data-aos="fade-up"
          data-aos-delay="100">
          Experience the engineering excellence of MOGESAN Pistons and Piston
          Rings through our immersive 360° interactive product view. Rotate each
          component from every angle to examine its precision machining, surface
          finish, structural design, and manufacturing quality. Explore every
          detail with confidence and discover why MOGESAN products are trusted
          in more than 80 countries for superior engine performance, durability,
          and reliability.
        </p>
