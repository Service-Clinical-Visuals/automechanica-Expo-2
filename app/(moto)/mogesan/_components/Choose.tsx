        ...
        >
          <div className="w-full xl:max-w-[1107px]">
            ...
            <p className="body-text text-white">
              ...
              precision to withstand the toughest engine operating
              conditions. Our advanced manufacturing processes, strict
              quality inspections, and continuous product development ensure
              every component delivers consistent performance, maximum
