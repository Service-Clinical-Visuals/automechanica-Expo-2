...
export default function Premium() {
  return (
    <section className="relative w-full py-20 md:py-28 overflow-hidden bg-[#101820]" id="premium">
      <Container className="relative z-10">
        {/* Header row */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
          <div className="max-w-full lg:max-w-[60%]">
            <h2 className="heading-white mb-4">Explore Innovation From Every Angle</h2>
            <p className="content-white opacity-80">
              Discover KALE&apos;s advanced thermal management solutions through an immersive 360°
              experience, highlighting the engineering, precision, and innovative technology behind
              every product. Explore the quality, performance, and attention to detail built into
              every solution.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] gap-10 lg:gap-16 items-center">
          ...
          <div data-aos="fade-right" className="flex flex-col gap-8">
            <p className="content-white opacity-80">
              Explore advanced thermal management solutions engineered to deliver reliable
              performance, efficient cooling, and long-term durability across a wide range of
              demanding automotive applications. Designed with precision and innovation, each
              solution ensures consistent performance, efficiency, and dependable operation in
              every environment.
            </p>
