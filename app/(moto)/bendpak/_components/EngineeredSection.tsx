...
export default function EngineeredSection() {
  return (
    <section className="py-16 xl:py-20 min-[2100px]:py-28 min-[3800px]:py-40 relative overflow-hidden bg-[#171717]">
      <div className="custom-container relative z-10">

        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 xl:gap-10 min-[2100px]:gap-14 min-[3800px]:gap-20 items-center">

          {/* Left Video Player */}
          <div className="w-full h-full relative overflow-hidden rounded-[5px] xl:col-span-7 flex items-center justify-center" data-aos="fade-right">
            <DynamicVideoPlayer type="short-1" className="w-full h-full aspect-video object-cover" />
          </div>

          {/* Right Content */}
          <div className="flex flex-col xl:col-span-5 text-white" data-aos="fade-left">
