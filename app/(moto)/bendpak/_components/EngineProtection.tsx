...
export default function EngineProtection() {
  return (
    <section className="py-16 lg:py-20 relative overflow-hidden bg-[#161616] text-white">
      <div className="custom-container relative z-10 flex flex-col items-center text-center">
        ...
        <p className="inter-font text-white/90 font-regular section-text leading-relaxed max-w-7xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">
        ...
        {/* Video Player */}
        <div className="w-full h-full lg:max-w-[80%] 2xl:max-w-[80%] aspect-video rounded-[5px] flex items-center justify-center mb-10 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
          <DynamicVideoPlayer type="short-2" className="w-full h-full object-cover" />
        </div>

        {/* Bottom Text & Button */}
        <div className="flex flex-col md:flex-row items-center justify-between w-full lg:max-w-[80%] 2xl:max-w-[80%] mx-auto gap-6 text-left" data-aos="fade-up" data-aos-delay="300">
          <p className="inter-font text-white/90 font-regular section-text leading-relaxed md:max-w-[75%]">
