...
export default function Premium() {
  return (
    <section className="relative w-full bg-[#1A1A1A] py-16 md:py-24 overflow-hidden" id="premium">
      <Container className="relative z-10">
        <div className="grid grid-cols-1 xl:grid-cols-[50fr_50fr] gap-8 items-center">
          ...
          <div data-aos="fade-left" className="order-1 xl:order-2">
            <h2 className="heading-white mb-3">
              Precision Designed for Reliable Engine Performance
            </h2>
            <span className="block lg:w-[70%] h-1 bg-primary mb-6 mt-2" />

            <p className="content-white opacity-80 mb-6">
              Yenmak engine components are manufactured with precision to meet the demanding
              requirements of modern engines. From pistons and piston pins to piston rings, each
              component is designed for accurate fitment, durability and dependable performance
              throughout the engine&apos;s operating cycle.
            </p>
            ...
            <Button text="Explore Product" href="#product" variant="secondary" />
          </div>
        </div>
      </Container>
    </section>
