        ...
        <div className="px-4 sm:px-8 md:px-14 lg:px-[60px]">
          ...
          <div className="text-center" data-aos="fade-up">
            ...
            <p className="content-white text-center max-w-[1100px] mx-auto mt-4">
              Sarofim GmbH Engine Oils combine carefully selected base oils and
              advanced formulation technology to deliver consistent performance
              for a wide range of modern vehicles. Designed to meet demanding
              lubrication requirements, they provide dependable protection while
              supporting engine cleanliness, efficiency, and smooth operation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[70fr_30fr] gap-10 xl:gap-16 items-stretch">
            ...
            <div data-aos="fade-left" data-aos-delay="150">
              <h3 className="heading-white font-bold text-[32px]!">
                Key Features
              </h3>
              <hr className="border-t border-white/15 mt-4 mb-5" />

              <p className="content-white mb-6">
                Sarofim GmbH Engine Oils are developed using modern formulation
                technologies to meet the evolving demands of today&apos;s
                engines.
              </p>
              ...
              <p className="content-white mb-8">
                Designed for consistent performance across diverse driving
                conditions, these advanced lubricants help minimize friction and
                wear while protecting essential engine components.
              </p>
