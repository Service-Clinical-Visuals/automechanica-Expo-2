...
export default function PrecisionIgnition() {
  return (
    <section className="pt-20 lg:pt-20 w-full bg-white">
      <div className="custom-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-4" data-aos="fade-right">
            ...
            <div className="flex flex-col gap-5 lg:gap-6 pt-2 lg:hidden 2lg:flex">
              {features.map((feature, idx) => (
                <div key={idx} className="relative flex items-center bg-white shadow-[0_4px_15px_rgba(0,0,0,0.06)] rounded-sm border border-gray-100 ml-6 lg:ml-8 lg:ml-6 2lg:ml-8 min-h-[85px] lg:min-h-[100px] lg:min-h-[85px] 2lg:min-h-[100px]">

                  {/* Recessed Notch (Half-shadow illusion) */}
                  <div className="absolute left-[-24px] lg:left-[-32px] lg:left-[-24px] 2lg:left-[-32px] top-1/2 -translate-y-1/2 w-[60px] lg:w-[72px] lg:w-[60px] 2lg:w-[72px] h-[60px] lg:h-[72px] lg:h-[60px] 2lg:h-[72px] z-10 flex-shrink-0">
                    ...
                    <div className="absolute top-0 bottom-0 right-0 left-[24px] lg:left-[32px] lg:left-[24px] 2lg:left-[32px] overflow-hidden rounded-r-md pointer-events-none">
                      {/* The shadow element (full size, but anchored right so left half is clipped) */}
                      <div className="absolute top-0 bottom-0 right-0 w-[60px] lg:w-[72px] lg:w-[60px] 2lg:w-[72px] shadow-[inset_0_2px_8px_rgba(0,0,0,0.15)] rounded-md"></div>
                    </div>

                    {/* The Red Box */}
                    <div className="absolute inset-0 p-[6px] lg:p-[8px] lg:p-[6px] 2lg:p-[8px] flex items-center justify-center">
                  ...
                  {/* Text Content */}
                  <div className="relative z-10 py-4 pr-4 pl-[48px] lg:py-5 lg:pr-6 lg:pl-[64px] lg:pl-[48px] lg:py-4 2lg:pl-[64px] 2lg:py-5 flex items-start gap-2 lg:gap-2 w-full">
                    <div className="flex-shrink-0 mt-0.5">
                      <img src="/moto/bremi/check.png" alt="Check" className="w-5 h-5 lg:w-7 lg:h-7 lg:w-7 lg:h-7 2lg:w-8 2lg:h-8 object-contain" />
                    </div>
          ...
          {/* Right Column (Video) */}
          <div className="lg:col-span-8 mt-12 lg:mt-0 lg:pl-10 aspect-video" data-aos="fade-left">
            {/* Video Player */}
        ...
        <div className="hidden lg:grid 2lg:hidden grid-cols-3 gap-6 mt-12" data-aos="fade-up">
          {features.map((feature, idx) => (
