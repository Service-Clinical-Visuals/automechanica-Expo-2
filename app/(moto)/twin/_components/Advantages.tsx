...
export default function Advantages() {
  return (
    <section className="pt-20 lg:pt-20 relative w-full bg-white">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-[#1A1A1A] hidden lg:block"></div>
      <div className="absolute top-0 left-0 w-2/3 h-full bg-[#e30613] hidden lg:block opacity-5"></div>

      <div className="custom-container relative z-10">
        {/* Heading & Subtitle */}
        <div className="text-center max-w-5xl mx-auto mb-12 lg:mb-16" data-aos="fade-up">
          <h2 className="section-title text-[#E72E39] font-bold mb-6 lg:mb-6 ">
            Benefit From The Advantages Of BREMI Car Systems
          </h2>
          <p className="section-text text-[#1a1a1a] leading-[1.6] font-normal">
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 2lg:grid-cols-4 gap-10 mb-12 lg:mb-16">
          {advantagesData.map((item, index) => (
            ...
            >
              <h3 className="card-title font-semibold text-[#333333] mb-4 h-[80px] mt-8 flex items-center justify-center whitespace-pre-line">
                {item.title}
              </h3>
              <div className="w-full h-[1px] bg-gray-200 mb-6"></div>
              <p className="section-text text-[#6E777D] leading-[1.6] mb-6 flex-grow font-normal">
                {item.desc}
              </p>
              <Link href="#" className="btn-text text-[#E72E39] font-bold hover:underline tracking-wide mt-2 lg:mt-2 mb-8 inline-block underline">
                Read More &gt;&gt;
              </Link>
            </div>
          ))}
