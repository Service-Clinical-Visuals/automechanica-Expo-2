...
export default function ProductRange() {
  ...
  return (
    <section className="pt-20 lg:pt-20 w-full bg-[#1e1e1e]">
      <div className="custom-container overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 lg:mb-16" data-aos="fade-up">
          <h2 className="section-title text-[#E72E39] font-bold mb-6 inline-block border-b-2 border-[#E72E39] pb-1">
            Explore Our Product Range
          </h2>
          <p className="section-text text-gray-300 leading-[1.6] font-normal">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          >
            {/* Slide 1 */}
            <div className="w-full flex-shrink-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 2lg:grid-cols-5 gap-4 lg:gap-6">
              {products.slice(0, 5).map((product, index) => (
                <div
                  key={index}
                  className={`bg-white relative p-4 lg:p-5 flex flex-col h-full group lg:col-span-2 2lg:col-span-1 ${index === 3 ? "lg:col-start-2 2lg:col-start-auto" : ""
                    } ${index === 4 ? "sm:col-span-2 sm:w-[calc(50%-8px)] sm:mx-auto lg:w-auto lg:mx-0" : ""
                    }`}
                  data-aos="fade-up"
                ...
                >
                  ...
                  <div className="flex flex-col flex-grow mt-2">
                    <h3 className="card-title font-semibold text-[#333333] mb-3 pb-3 border-b border-gray-200 ">{product.title}</h3>
                    <p className="card-text text-[#6E777D] leading-[1.6] mb-1 flex-grow font-normal">
                      {product.description}
                    </p>
                    <Link href="#" className="btn-text text-[#E72E39] font-bold hover:underline tracking-wide mt-2 lg:mt-4 underline inline-block">
                      Read More &gt;&gt;
                    </Link>
                  </div>
                </div>
