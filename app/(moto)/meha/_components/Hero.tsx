      ...
      <Container>
        <div className="relative z-10 pb-20 md:pb-32 lg:pb-40">
          <div className="max-w-4xl text-left" data-aos="fade-up" data-aos-delay="200">
            <h1 className="heading-white font-semibold! text-[36px]! leading-[120%]! mb-6 tracking-[0%]! max-w-[550px] text-white">
              Precision Metal Solutions
            </h1>
            <p className="content-white">
              High-quality metal components designed for the automotive industry.
            </p>
          </div>
        </div>
      </Container>
