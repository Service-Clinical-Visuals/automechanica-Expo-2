...
export default function ResearchDevelopment() {
  return (
    <section className="w-full bg-[#0D0D0D] py-16 lg:py-24">
      <div className="custom-container grid grid-cols-1 lg:grid-cols-[533px_1fr] gap-10 lg:gap-16 items-start lg:items-center">

        {/* Left Image */}
        <div
          className="group relative w-full aspect-[533/828] border border-mid overflow-hidden transition-all duration-700 ease-out hover:-translate-y-1 hover:border-primary hover:shadow-[0_12px_30px_rgba(0,0,0,0.35)]"
          data-aos="fade-right"
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            ...
            {/* Research Image */}
            <div
              className="group relative w-full aspect-[534/350] min-[2000px]:aspect-[534/325] min-[3000px]:aspect-[534/260] border border-mid overflow-hidden shadow-[0_3px_8px_rgba(0,0,0,0.24)] transition-all duration-700 ease-out hover:-translate-y-1 hover:border-primary hover:shadow-[0_10px_25px_rgba(0,0,0,0.35)]"
              data-aos="fade-up"
              data-aos-duration="800"
              data-aos-delay="250"
            >
            ...
            {/* Development Image */}
            <div
              className="group relative w-full aspect-[533/350] min-[2000px]:aspect-[533/325] min-[3000px]:aspect-[533/260] border border-mid overflow-hidden shadow-[0_3px_8px_rgba(0,0,0,0.24)] transition-all duration-700 ease-out hover:-translate-y-1 hover:border-primary hover:shadow-[0_10px_25px_rgba(0,0,0,0.35)]"
              data-aos="fade-up"
              data-aos-duration="800"
              data-aos-delay="400"
            >
