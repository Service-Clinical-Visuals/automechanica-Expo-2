...
export default function Typography({
  ...
  const variantStyles = {
    h1: "text-[30px] sm:text-[32px] md:text-[34px] lg:text-[36] xl:text-[38px] leading-[1.1] tracking-tight ",
    ...
    body: "text-[15px] sm:text-[16px] md:text-[18px] lg:text-[18px] xl:text-[20px] leading-[1.65]",
    lead: "text-[16px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[18px] leading-[1.6]",
    small: "text-[13px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[15px] leading-[1.5]",
  };
  ...
  const fontClass = isHeading ? "font-instrumental" : "font-instrumental";
