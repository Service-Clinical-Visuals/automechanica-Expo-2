      ...
      <Container>
        <div className="relative z-10 pb-20 md:pb-32 lg:pb-40">
          <div className="max-w-4xl text-left" data-aos="fade-up" data-aos-delay="200">
            <h1 className="heading-white font-semibold! text-[36px]! leading-[120%]!  tracking-[0%]! max-w-[550px] text-white mb-8">
              Precision Clutch Solutions for Every Drive
            </h1>
          </div>
          <button className=" flex gap-2 rounded-sm items-center content-white px-8 py-2.5 bg-primary">
              Explore Products
          </button>
        </div>
      </Container>
