      ...
      <div className="custom-container-wide">
        <div className="bg-[#00355B] rounded-[24px] px-6 py-14 sm:px-10 md:px-14 xl:px-[98px] xl:py-[75px]">
          ...
          <div className="flex flex-col min-[1100px]:flex-row min-[1100px]:items-center gap-10 min-[1100px]:gap-12">
            {/* 360 video */}
            <div
              className="relative w-full min-[1100px]:flex-[2.1] aspect-[1065.65/650] rounded-[24px] overflow-hidden bg-[#012440]"
              data-aos="zoom-in"
            ...
            >
              ...
              <div className="flex flex-col gap-5 min-[750px]:max-[1950px]:gap-3 min-[1200px]:max-[1500px]:!gap-2">
                {features.map((feature, index) => (
                  <div
                    key={feature.title}
                    className="group/card flex items-start gap-5 bg-[rgba(0,53,91,0.4)] border border-white rounded-2xl p-7 min-[750px]:max-[1950px]:gap-4 min-[750px]:max-[1950px]:p-5 min-[1200px]:max-[1500px]:!gap-3 min-[1200px]:max-[1500px]:!p-3.5 min-[1200px]:max-[1500px]:!rounded-xl transition-[transform,background-color] duration-700 ease-[cubic-bezier(0.25,0.8,0.25,1)] hover:-translate-y-1 hover:bg-[rgba(0,53,91,0.7)]"
                    data-aos="fade-up"
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 min-[1200px]:max-[1500px]:!gap-0.5">
                      <span className="stat-title font-bold text-white min-[750px]:max-[1950px]:text-sm min-[1200px]:max-[1500px]:!text-[12px]">
                        {feature.title}
                      </span>
